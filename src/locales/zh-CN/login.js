export default {
  'app.login.tab-login-student': '学生登录',
  'app.login.stuNumber': '学生学号',
  'app.login.stuPassword': '密　　码',
  'app.login.message-invalid-credentials-stu': '学号或密码错误',
  'validation.stuNumber.required': '请输入学生学号!',
  'validation.stuPassword.required': '请输入密码！',

  'app.login.tab-login-teacher': '教师登录',
  'app.login.teaNumber': '教师工号',
  'app.login.teaPassword': '密　　码',
  'app.login.message-invalid-credentials-tea': '工号或密码错误',
  'validation.teaNumber.required': '请输入教师工号!',
  'validation.teaPassword.required': '请输入密码！',
  ...
  'app.register-result.msg1': '恭喜您，注册成功。请返回登录页面进行登录',
  'app.register-result.activation-email':
    '激活邮件已发送到你的邮箱中，邮件有效期为24小时。请及时登录邮箱，点击邮件中的链接激活帐户。',

  'app.register-result.activation-user':
    '恭喜您，成功注册账号，祝您使用愉快。',

  'app.register-result.back-home': '返回首页',
  'app.register-result.view-mailbox': '查看邮箱',

  'app.register-result.back-to-login': '返回登录界面',

  'validation.username.required': '请输入账号',
  'validation.username.wrong-format': '账号格式错误！',
  ...
  'validation.oldPassword.required': '请输入旧密码！',
